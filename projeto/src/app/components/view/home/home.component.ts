...
export class HomeComponent {
  ...
  produtos: any[] = [
    ...
    { nome: 'Ração Golden', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com a Ração Golden, uma escolha premium para nutrição completa e equilibrada', preco: 287.99, parcelas: 'ou 3x de R$ 94,98', imagem: 'assets/img/imgcards/imgCardCachorro/racaocachorro1.jpg' },
    { nome: 'Cookie Golden', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com a nova linha Cookie Golden, uma escolha premium para nutrição completa e equilibrada', preco: 328.99, parcelas: 'ou 3x de R$ 108,98', imagem: 'assets/img/imgcards/imgCardCachorro/racaocachorro2.jpg' },
    { nome: 'Ração Royal', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com a nova linha Royal Canin, uma escolha premium para nutrição completa e equilibrada', preco: 311.99, parcelas: 'ou 3x de R$ 103,98', imagem: 'assets/img/imgcards/imgCardCachorro/racaocachorro3.jpg' },
    { nome: 'Galinha de Pelúcia', descricao: 'Explore o mundo do entretenimento animal com nossos Brinquedos para Cachorros, desta vez uma galinha de pelúcia com uma coleção cuidadosamente selecionada para manter seus amigos peludos entretidos e felizes.', preco: 31.99, parcelas: 'ou 3x de R$ 10,97', imagem: 'assets/img/imgcards/imgCardCachorro/brinquedocachorro1.jpg' },
    { nome: 'Ossos de Brinquedo', descricao: 'Explore o mundo do entretenimento animal com nossos Brinquedos para Cachorros, desta vez um osso de brinquedo junto de uma corda com uma coleção cuidadosamente selecionada para manter seus amigos peludos entretidos e felizes.', preco: 18.99, parcelas: 'ou 2x de R$ 9,97', imagem: 'assets/img/imgcards/imgCardCachorro/brinquedocachorro2.jpg' },
    ...
    // favorito dos gatos
    { nome: 'Ração Premier', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com a Ração Premier, uma escolha premium para nutrição completa e equilibrada', preco: 289.99, parcelas: 'ou 3x de R$ 103,98', imagem: 'assets/img/imgcards/imgCardGato/racaogato1.jpg' },
    { nome: 'Golden Gourmet', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com a Ração Golden Gourmet, uma escolha premium para nutrição completa e equilibrada', preco: 311.99, parcelas: 'ou 3x de R$ 108,96', imagem: 'assets/img/imgcards/imgCardGato/racaogato2.jpg' },
    { nome: 'Atum Royal', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com o Atum Royal Canin, uma escolha premium para nutrição completa e equilibrada', preco: 211.99, parcelas: 'ou 2x de R$ 94,98', imagem: 'assets/img/imgcards/imgCardGato/racaogato3.jpg' },
    { nome: 'Whiskas Salmão', descricao: 'Cuide da saúde e bem-estar do seu fiel companheiro com a Whiskas Salmão, uma escolha premium para nutrição completa e equilibrada', preco: 241.99, parcelas: 'ou 3x de R$ 91,98', imagem: 'assets/img/imgcards/imgCardGato/racaogato4.jpg' },
    { nome: 'Antipulgas', descricao: 'Mantenha seu felino protegido e saudável com o nosso Antipulgas para Gatos, uma solução eficaz e confiável para o controle da pele do seu felino.', preco: 54.99, parcelas: 'ou 2x de R$ 27,45', imagem: 'assets/img/imgcards/imgCardGato/brinquedogato1.jpg'},
    { nome: 'Casinha Aconchegante', descricao: 'Proporcione ao seu felino um refúgio acolhedor e encantador com nossa Casinha de Papelão Reciclável, o lugar perfeito para descanso e relaxamento.', preco: 322.99, parcelas: 'ou 3x de R$ 121,25', imagem: 'assets/img/imgcards/imgCardGato/brinquedogato3.jpg' },
